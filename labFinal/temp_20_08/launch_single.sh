...
nsys profile --force-overwrite=true --stats=true --output=output/lab_final ./blur /clusteruy/home/gpgpu26/labFinal/imagnes_pgm/fing1_ruido.pgm > output/lab_final.out
